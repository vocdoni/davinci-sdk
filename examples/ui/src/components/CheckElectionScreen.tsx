          ...
          {error ? (
            ...
            <>
              <List>
                ...
                {renderCheckItem('Election process created', checkStatus.processExists, !checkStatus.processExists && checkStatus.detailsLoaded)}
                {renderCheckItem('Election ready for voting', checkStatus.acceptingVotes, !checkStatus.acceptingVotes && checkStatus.processExists)}
              </List>

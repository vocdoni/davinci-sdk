  ...
  return (
    <Box sx={{ maxWidth: 800, mx: 'auto', textAlign: 'center' }}>
      ...
      <Typography variant='body1' color='text.secondary' paragraph sx={{ mb: 4 }}>
        Connect your wallet to interact with the Vocdoni voting protocol. You can use MetaMask or enter your private key
        directly. Make sure you have some Sepolia ETH to proceed.
      </Typography>
      ...
      <Box sx={{ mt: 4, display: 'flex', gap: 2, justifyContent: 'center' }}>
        ...
        <Button variant='contained' color='primary' disabled={!wallet} onClick={onNext}>
          Next
        </Button>
      </Box>
    </Box>
